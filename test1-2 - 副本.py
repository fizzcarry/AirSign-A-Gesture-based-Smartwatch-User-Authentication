...
for i,json_file in enumerate(json_files):
    ...
    pre1=DTW_classification2(one_sample_dict,median_feature_dict,median_value_dict,np.array(data_dict["series1"]).T,feature_type=feature_type)
    pre2 = DTW_classification2(one_sample_dict, median_feature_dict,median_value_dict, np.array(data_dict["series2"]).T, feature_type=feature_type)
    if pre1==pre2:
        TA_number+=1
